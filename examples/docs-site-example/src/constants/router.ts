...
export const contentRoutes: SidebarRouteConfig[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/03/034-第三十四章-造就我们的那些羁绊.md',
